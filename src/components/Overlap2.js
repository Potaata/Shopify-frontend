        ...
        <div className="row justify-content-between">
          <div className="col-lg-6 mb-5 mb-lg-0">
            ...
            <div className="imgs-grid ">
              ...
              <div className="grid grid-2 hidden lg:block">
              ...
              <div className="grid grid-3 hidden lg:block">
              ...
              <div className="grid grid-4 h-20 w-16 bg-yellow-500 rounded-xl flex flex-col justify-center items-center shadow duration-300 hover:bg-yellow-700 hover:shadow-xl hidden lg:block">
                <svg
              ...
              <div className="woo-card relative flex w-full max-w-[26rem] h-[6rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-none hidden lg:block">
