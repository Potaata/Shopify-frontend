...
const Service = () => {
  ...
  return (
    <div className="max-w-7xl lg:flex lg:items-start lg:gap-8 flex justify-center">
      <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16 flex justify-between items-center">
        <div className="col-span-2 pb-10">
          <div>
            ...
            <h2 className="text-4xl font-thin leading-none tracking-wide text-black">
              Most Popular
            </h2>
            <h2 className="text-4xl font-thin leading-none tracking-wide text-black">
              Shopify Services
        ...
        <div className="col-span-2 ml-auto pb-10 lg:col-span-3 lg:flex lg:items-end">
          <a
            ...
            href="/"
          >
            <span className="text-xs font-medium mr-12">View All Services</span>
